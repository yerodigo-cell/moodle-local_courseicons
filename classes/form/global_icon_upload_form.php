...
/**
 * Form for uploading a global custom SVG icon for a course module type.
 *
...
/**
 * Class global_icon_upload_form.
 */
class global_icon_upload_form extends moodleform {
    /**
     * Form definition.
     */
    public function definition(): void {
        ...
        $mform->addElement('hidden', 'modname', $modname);
        $mform->setType('modname', PARAM_ALPHANUMEXT);

        $headingtext = get_string('uploaddefaulticon', 'local_courseicons', get_string('pluginname', 'mod_' . $modname));
        ...
        $mform->addElement(
            ...
            get_string('uploadicon', 'local_courseicons', get_string('pluginname', 'mod_' . $modname)),
            null,
            $filemanageropts
        );
